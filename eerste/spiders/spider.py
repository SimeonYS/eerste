...
payload="{{\"filter\":[{{\"key\":\"path\",\"value\":\"/content/sites/at/eh/www_erstegroup_com/en/news-media/news-views\"}},{{\"key\":\"tags\",\"value\":\"at:eh/news/CEEInsights,at:eh/news/CorporateBanking,at:eh/news/CorporateNews,at:eh/news/Innovation,at:eh/news/PeopleProsperity,at:eh/news/Personnel,at:eh/news/Research,at:eh/news/Results,at:eh/news/RetailBanking\"}}],\"page\":{},\"query\":\"*\",\"items\":10,\"sort\":\"DATE_RELEVANCE\",\"requiredFields\":[{{\"fields\":[\"teasers.NEWS_DEFAULT\",\"teasers.NEWS_ARCHIVE\",\"teasers.newsArchive\"]}}]}}"
headers = {
  ...
  'Referer': 'https://www.erstegroup.com/en/news-media/news-views',
  'Accept-Language': 'en-US,en;q=0.9',
  'Cookie': 'TCPID=121241318275207497273; TC_PRIVACY=0@021@1@2@1613647109076@; TC_PRIVACY_CENTER=1; s_fid=2A05616784669697-0E5E6F84BD338769; _cs_c=1; _CT_RS_=Recording; WRUID=3171560824275002; 3cf5c10c8e62ed6f6f7394262fadd5c2=ffb311b6d6c2f7e071b7c1a53fef5c06; f6060f4f56791feac32c0502db744887=a268b48dd6ac23c5ae199d14b474c6f3; s_cc=true; s_sq=%5B%5BB%5D%5D; _cs_cvars=%7B%221%22%3A%5B%22Page%20Name%22%2C%22news-views%22%5D%2C%222%22%3A%5B%22Page%20Title%22%2C%22News%20%26%20Views%22%5D%2C%223%22%3A%5B%22Page%20Template%22%2C%22standardContentPage%22%5D%2C%224%22%3A%5B%22Language%22%2C%22en%22%5D%7D; _cs_id=708899a2-a80b-acea-e55a-bd8654377b08.1613647110.4.1615902786.1615901908.1.1647811110209.Lax.0; _cs_s=14.1; __CT_Data=gpv=38&ckp=tld&dm=erstegroup.com&apv_59_www56=38&cpv_59_www56=38&rpv_59_www56=38'
}

class EersteSpider(scrapy.Spider):
	name = 'eerste'
	start_urls = ['https://www.erstegroup.com/en/news-media/news-views']
	page = 0
	count_of_items = 0
	...
	def parse_post(self, response):
		try:
			date = response.xpath(
				'(//div[@class="col col-md-10 offset-md-1"]//div[@class="w-auto mw-full rte"]/p)[1]/text()').get().strip()
		except AttributeError:
			date = "-"
		title = response.xpath(
			'//h1/text() | //h2[@class="align-center"]/text() | (//div[@class="w-auto mw-full rte"]/h2)[1]/text()').get().strip()
		...
		item = ItemLoader(item=EersteItem(), response=response)
